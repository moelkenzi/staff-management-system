...
import { Orbit } from "../custom/Orbit";
import ChipViz from "../custom/ChipViz";
import { LogoMark } from "../global/icons";
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Monitor and manage your team efficiently
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Access real-time attendance, task status, and performance insights. Keep track of
            employee activity and streamline operations across departments with ease.
          </p>
        </div>
              ...
              <Orbit
                ...
                orbitingObjects={[
                  <div key="obj1" className="relative flex items-center justify-center">
                    <RiUserLine className="z-10 size-5 text-gray-900" />
                    ...
                    <div
                      ...
                      className="absolute size-10 animate-[ping_7s_ease_infinite] rounded-full ring-1 ring-purple-500/50"></div>
                  </div>,
                  ...
                  <div key="obj2" className="relative flex items-center justify-center">
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 whitespace-nowrap text-xs ring-1 ring-gray-200 w-fit">
                          Payroll
                        </div>
                      </div>
                    </div>
                  ...
                  <div key="obj3" className="relative flex items-center justify-center">
                    <RiListIndefinite className="z-10 size-5 text-gray-900" />
                    {/* <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        <div className="flex items-center justify-center rounded-l-full bg-purple-500 p-1 text-xs ring-1 ring-gray-200">
                          <RiCheckboxMultipleBlankFill className="size-3 shrink-0 text-white" />
                        </div>
                  ...
                  <div key="obj4" className="relative flex items-center justify-center">
                    <RiCheckLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div key="obj5" className="relative flex items-center justify-center">
                    <RiNotification2Line className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                ...
                <div className="relative flex h-48 w-48 items-center justify-center">
                  <div className="rounded-full p-1 ring-1 ring-black/10">
                    ...
                    <div className="absolute inset-12 animate-[spin_8s_linear_infinite] rounded-full bg-linear-to-t from-transparent via-purple-400 to-transparent blur-lg" />
                  </div>
                </div>
              </Orbit>
            </div>
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Transform your workforce into an organized, efficient team
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Streamline employee scheduling, attendance tracking, and performance monitoring with our
            intelligent platform. Make data-driven decisions faster, improve productivity, and
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative text-lg font-semibold tracking-tight text-purple-500">
            Easy Expansion
            <div className="absolute top-1 -left-[7px] h-5 w-[3px] rounded-r-sm bg-purple-500" />
          </h2>
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
          ...
          <div className="pointer-events-none relative flex size-full h-[26rem] items-center justify-center p-10 select-none">
            <div className="relative">
              ...
              <div className="absolute top-[6rem] right-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 ring-1 shadow-md shadow-black/10 ring-black/10">
                  <div className="w-fit rounded-full bg-linear-to-b from-white to-gray-100 p-3 ring-1 shadow-[inset_0px_-2px_6px_rgba(0,0,0,0.05),0_7px_10px_0_rgba(0,0,0,0.10)] ring-white/50 ring-inset">
                    <RiDatabaseLine className="size-5 text-gray-900" aria-hidden="true" />
                  </div>
                </div>
              </div>
              <div className="absolute right-[6rem] bottom-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 ring-1 shadow-md shadow-black/10 ring-black/10">
                  <div className="w-fit rounded-full bg-linear-to-b from-white to-gray-100 p-3 ring-1 shadow-[inset_0px_-2px_6px_rgba(0,0,0,0.05),0_7px_10px_0_rgba(0,0,0,0.10)] ring-white/50 ring-inset">
                    <RiLineChartLine className="size-5 text-gray-900" aria-hidden="true" />
                  </div>
                </div>
              </div>
              <div className="absolute bottom-[6rem] left-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 ring-1 shadow-md shadow-black/10 ring-black/10">
                  <div className="w-fit rounded-full bg-linear-to-b from-white to-gray-100 p-3 ring-1 shadow-[inset_0px_-2px_6px_rgba(0,0,0,0.05),0_7px_10px_0_rgba(0,0,0,0.10)] ring-white/50 ring-inset">
                    <RiShieldKeyholeLine className="size-5 text-gray-900" aria-hidden="true" />
                  </div>
                </div>
              </div>
            </div>
              ...
              {[0, 45, 135, 180, 225, 315, 360].map((rotation, index) => (
                <div
                  ...
                  <div className="relative">
                    ...
                    <div
                      className="absolute top-0 left-0 h-0.5 w-28 bg-linear-to-r from-transparent via-purple-300 to-transparent"
                      style={{
